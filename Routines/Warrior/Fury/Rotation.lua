...
local isZhCN = (clientLocale == "zhCN" or clientLocale == "zhTW")
...
L.IntroTalents = isZhCN and "关于天赋" or "About Talents"
L.IntroTalentsText = isZhCN and "目前只支持屠戮天赋" or "Currently only supports Slaughter talent"
L.IntroQueue = isZhCN and "关于技能插入" or "About Skill Queue"
L.IntroQueueText = isZhCN and "我们使用Aurora原生SmartQueue" or "We use Aurora's native SmartQueue"
...
L.EnableTrinket2 = isZhCN and "启用饰品2" or "Enable Trinket 2"
L.TrinketWithBurst = isZhCN and "饰品跟随爆发使用" or "Use Trinkets with Burst"
L.Trinket1Tooltip = isZhCN and "自动使用第一个饰品槽位的主动饰品" or "Auto-use active trinket in first slot"
L.Trinket2Tooltip = isZhCN and "自动使用第二个饰品槽位的主动饰品" or "Auto-use active trinket in second slot"
L.TrinketWithBurstTooltip = isZhCN and "勾选: 仅在爆发技能启用时使用饰品\n不勾选: 战斗中CD好就用" or "Checked: Use only when burst active\nUnchecked: Use on CD"

-- Potions
L.EnableHealthstone = isZhCN and "启用治疗石" or "Enable Healthstone"
L.HealthstoneTooltip = isZhCN and "自动使用治疗石恢复生命值" or "Auto-use healthstone to restore health"
L.HealthstoneThreshold = isZhCN and "治疗石血量阈值 (%)" or "Healthstone Health Threshold (%)"
L.HealthstoneThresholdTooltip = isZhCN and "当生命值低于此百分比时自动使用治疗石" or "Auto-use when health below this %"

L.EnableHealingPotion = isZhCN and "启用治疗药水" or "Enable Healing Potion"
L.HealingPotionTooltip = isZhCN and "自动使用阿加治疗药水恢复生命值" or "Auto-use healing potion to restore health"
L.HealingPotionThreshold = isZhCN and "治疗药水血量阈值 (%)" or "Healing Potion Health Threshold (%)"
L.HealingPotionThresholdTooltip = isZhCN and "当生命值低于此百分比时自动使用阿加治疗药水\n按品质依次尝试: 史诗 > 稀有 > 优秀" or "Auto-use when health below this %\nTries by quality: Epic > Rare > Uncommon"

L.EnableCombatPotion = isZhCN and "启用爆发药水" or "Enable Combat Potion"
L.CombatPotionTooltip = isZhCN and "自动使用爆发药水增强输出" or "Auto-use combat potion to boost damage"
L.CombatPotionWithBurst = isZhCN and "爆发药水跟随爆发技能" or "Combat Potion with Burst"
L.CombatPotionWithBurstTooltip = isZhCN and "勾选: 仅在爆发技能启用时使用爆发药水\n不勾选: 战斗中CD好就用" or "Checked: Use only when burst active\nUnchecked: Use on CD"

-- Auxiliary Skills
L.UseEnragingRegen = isZhCN and "使用狂暴回复" or "Use Enraging Regeneration"
L.EnragingRegenTooltip = isZhCN and "自动使用狂暴回复来恢复生命值" or "Auto-use to restore health"
L.UseVictoryRush = isZhCN and "使用胜利在望" or "Use Victory Rush"
L.VictoryRushTooltip = isZhCN and "自动使用胜利在望来恢复生命值" or "Auto-use to restore health"
L.HealthThreshold = isZhCN and "生命值阈值 (%)" or "Health Threshold (%)"
L.UseSpellReflection = isZhCN and "使用法术反射" or "Use Spell Reflection"
...
L.AuroraListTooltip = isZhCN and "启用：只打断列表中的技能\n禁用：打断所有可打断技能\n\n💡 打断功能受Cooldown框架控制" or "Enabled: Only interrupt spells in list\nDisabled: Interrupt all interruptible spells\n\n💡 Controlled by Cooldown framework"
L.InterruptCastProgress = isZhCN and "施法进度 (%)" or "Cast Progress (%)"
L.InterruptCastTooltip = isZhCN and "怪物施法进度 ≥ 此值才打断" or "Only interrupt when cast ≥ this %"
L.UsePummel = isZhCN and "使用拳击" or "Use Pummel"
L.PummelTooltip = isZhCN and "主要打断技能，15秒CD，15码范围" or "Main interrupt, 15s CD, 15yd range"
L.UseStormBolt = isZhCN and "使用风暴之锤" or "Use Storm Bolt"
L.StormBoltTooltip = isZhCN and "远程打断，30秒CD，40码范围\n读条怪物数量 ≥ 设定值时使用" or "Ranged interrupt, 30s CD, 40yd range\nUse when casting enemies ≥ threshold"
...
L.RecklessnessTooltip = isZhCN and "1分钟CD，大幅提升暴击率\n\n强力爆发技能，建议开启" or "1min CD, greatly increases crit rate\n\nPowerful burst, recommended ON"
L.UseAvatar = isZhCN and "使用化身" or "Use Avatar"
L.AvatarTooltip = isZhCN and "1分30秒CD，显著提升伤害\n\n强力爆发技能，建议开启" or "1.5min CD, significantly boosts damage\n\nPowerful burst, recommended ON"
L.UseBladestorm = isZhCN and "使用剑刃风暴" or "Use Bladestorm"
L.BladestormTooltip = isZhCN and "1分30秒CD，AOE爆发\n\n多目标必开，建议启用" or "1.5min CD, AOE burst\n\nEssential for multi-target, recommended ON"
L.UseThunderousRoar = isZhCN and "使用雷霆咆哮" or "Use Thunderous Roar"
L.ThunderousRoarTooltip = isZhCN and "强力AOE爆发技能" or "Powerful AOE burst skill"
L.TTDThreshold = isZhCN and "TTD阈值 (秒)" or "TTD Threshold (sec)"
L.TTDTooltipGeneric = isZhCN and "目标预计存活时间 ≥ 此值才使用" or "Only use when target TTD ≥ this value"

-- Talents
L.TalentSlaughter = isZhCN and "大米屠戮天赋" or "M+ Slaughter Talent"
L.TalentSlaughterTooltip = isZhCN and "点击弹出天赋代码窗口\n适用场景：大秘境M+ / 团本AOE" or "Click to show talent code\nFor: M+ / Raid AOE"
L.TalentCopyInst = isZhCN and "请按 Ctrl+C 复制天赋代码" or "Press Ctrl+C to copy talent code"
...
if Aurora and Aurora.Config then
    ...
    Aurora.Config:SetDefault("fury.useVictoryRush", true)  -- ✅ 已修复目标检查，可以启用
...
local cfg = setmetatable({}, {
    __index = function(t, key)
        ...
        if key == "useVictoryRush" then return GetConfig("useVictoryRush", true) end  -- ✅ 已修复
...
-- 胜利在望 - ✅ 最终修复：不检查 buff，直接尝试
S.VictoryRush:callback(function(spell)
    if not cfg.useVictoryRush then
        return false
    end
    
    local health = tonumber(player.healthpercent) or 100
    if health > (cfg.victoryRushThreshold or 40) then
        return false
    end
...
local function HasRecentDelayedInterrupt()
    ...
    if S.StormBolt and S.StormBolt:timeSinceLastCast() < 1.0 then
        return true
    end
...
local function SimCRotationV2()
    ...
    -- ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
    -- 【生存技能 - 需要目标】胜利在望
    -- ✅ 终极修复：使用 execute() 机制，避免直接调用 cast()
    -- ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
    if cfg.useVictoryRush then
        local health = tonumber(player.healthpercent) or 100
        
        -- 只在血量低于阈值时尝试
        if health <= (cfg.victoryRushThreshold or 40) then
            -- ✅ 使用 execute()，让 callback 来决定是否执行
            -- 这样即使失败也不会阻塞循环
            S.VictoryRush:execute()
            -- ⚠️ 注意：这里不 return，让循环继续
            -- callback 如果成功会自己处理，失败则不影响后续技能
        end
    end
...
if Aurora.Macro then
    ...
    gui:Category(L.RoutineName)
        :Tab(L.TabIntro)
        :Header({ text = (isZhCN and "欢迎使用TT狂战循环!" or "Welcome to TT Fury Rotation!") })
        :Spacer()
        
        :Text({
            text = "1. " .. L.IntroTarget,
            size = 15,
        ...
        :Tab(L.TabPotions)
        :Header({ text = L.TrinketHeader })
        :Checkbox({
            text = L.EnableTrinket1,
            key = "fury.trinket1.enabled",
            default = true,
            tooltip = L.Trinket1Tooltip,
            onChange = function(self, checked)
                cfg.useTrinket1 = checked
                Aurora.Config:Write("fury.trinket1.enabled", checked)
                print("|cff00ff00[" .. L.RoutineName .. "]|r " .. L.EnableTrinket1 .. " " .. (checked and (isZhCN and "已启用" or "Enabled") or (isZhCN and "已禁用" or "Disabled")))
            end
        })
        :Checkbox({
            text = L.EnableTrinket2,
            key = "fury.trinket2.enabled",
            default = true,
            tooltip = L.Trinket2Tooltip,
            onChange = function(self, checked)
                cfg.useTrinket2 = checked
                Aurora.Config:Write("fury.trinket2.enabled", checked)
                print("|cff00ff00[" .. L.RoutineName .. "]|r " .. L.EnableTrinket2 .. " " .. (checked and (isZhCN and "已启用" or "Enabled") or (isZhCN and "已禁用" or "Disabled")))
            end
        })
        :Checkbox({
            text = L.TrinketWithBurst,
            key = "fury.trinket1.withCooldowns",
            default = true,
            tooltip = L.TrinketWithBurstTooltip,
            onChange = function(self, checked)
                ...
                local mode = checked and (isZhCN and "跟随爆发" or "With Burst") or (isZhCN and "CD好就用" or "On CD")
                print("|cff00ff00[" .. L.RoutineName .. "]|r " .. L.TrinketWithBurst .. ": " .. mode)
            end
        })
        :Text({ text = "", size = 8 })
        :Header({ text = L.PotionsConsumables })
        :Checkbox({
            text = L.EnableHealthstone,
            key = "fury.healthstone.enabled",
            default = true,
            tooltip = L.HealthstoneTooltip,
            onChange = function(self, checked)
                cfg.useHealthstone = checked
                print("|cff00ff00[" .. L.RoutineName .. "]|r " .. L.EnableHealthstone .. " " .. (checked and (isZhCN and "已启用" or "Enabled") or (isZhCN and "已禁用" or "Disabled")))
            end
        })
        :Slider({
            text = L.HealthstoneThreshold,
            key = "fury.healthstone.threshold",
            min = 0,
            max = 100,
            step = 5,
            default = 40,
            tooltip = L.HealthstoneThresholdTooltip,
            onChange = function(self, value)
                cfg.healthstoneThreshold = value
                print("|cff00ff00[" .. L.RoutineName .. "]|r " .. L.HealthstoneThreshold .. ": " .. value .. "%")
            end
        })
        :Checkbox({
            text = L.EnableHealingPotion,
            key = "fury.healingPotion.enabled",
            default = true,
            tooltip = L.HealingPotionTooltip,
            onChange = function(self, checked)
                cfg.useHealingPotion = checked
                print("|cff00ff00[" .. L.RoutineName .. "]|r " .. L.EnableHealingPotion .. " " .. (checked and (isZhCN and "已启用" or "Enabled") or (isZhCN and "已禁用" or "Disabled")))
            end
        })
        :Slider({
            text = L.HealingPotionThreshold,
            key = "fury.healingPotion.threshold",
            min = 0,
            max = 100,
            step = 5,
            default = 35,
            tooltip = L.HealingPotionThresholdTooltip,
            onChange = function(self, value)
                cfg.healingPotionThreshold = value
                print("|cff00ff00[" .. L.RoutineName .. "]|r " .. L.HealingPotionThreshold .. ": " .. value .. "%")
            end
        })
        :Checkbox({
            text = L.EnableCombatPotion,
            key = "fury.combatPotion.enabled",
            default = true,
            tooltip = L.CombatPotionTooltip,
            onChange = function(self, checked)
                cfg.useCombatPotion = checked
                print("|cff00ff00[" .. L.RoutineName .. "]|r " .. L.EnableCombatPotion .. " " .. (checked and (isZhCN and "已启用" or "Enabled") or (isZhCN and "已禁用" or "Disabled")))
            end
        })
        :Checkbox({
            text = L.CombatPotionWithBurst,
            key = "fury.combatPotion.withCooldowns",
            default = true,
            tooltip = L.CombatPotionWithBurstTooltip,
            onChange = function(self, checked)
                cfg.combatPotionWithCooldowns = checked
                local mode = checked and (isZhCN and "跟随爆发技能" or "With Burst") or (isZhCN and "CD好就用" or "On CD")
                print("|cff00ff00[" .. L.RoutineName .. "]|r " .. L.CombatPotionWithBurst .. ": " .. mode)
            end
        })
    
    -- 辅助技能标签页
    gui:Tab(L.TabAuxiliary)
        :Header({ text = Aurora.texture(184364, 16) .. " " .. L.DefensiveSkills })
        :Checkbox({
            text = Aurora.texture(184364, 14) .. " " .. L.UseEnragingRegen,
            key = "fury.enragingRegeneration.enabled",
            default = true,
            tooltip = L.EnragingRegenTooltip,
            onChange = function(self, checked)
                cfg.useEnragingRegeneration = checked
                print("|cff00ff00[" .. L.RoutineName .. "]|r " .. L.UseEnragingRegen .. " " .. (checked and (isZhCN and "已启用" or "Enabled") or (isZhCN and "已禁用" or "Disabled")))
            end
        })
        :Slider({
        ...
        -- 胜利在望 - ✅ 已修复目标检查问题
        :Checkbox({
            text = Aurora.texture(34428, 14) .. " " .. L.UseVictoryRush,
            key = "fury.victoryRush.enabled",
            default = true,
            tooltip = L.VictoryRushTooltip,
            onChange = function(self, checked)
                cfg.useVictoryRush = checked
                print("|cff00ff00[" .. L.RoutineName .. "]|r " .. L.UseVictoryRush .. " " .. (checked and (isZhCN and "已启用" or "Enabled") or (isZhCN and "已禁用" or "Disabled")))
            end
        })
        :Slider({
            text = L.HealthThreshold,
        ...
        -- 法术反射
        :Checkbox({
            text = Aurora.texture(23920, 14) .. " " .. L.UseSpellReflection,
            key = "fury.useSpellReflection",
            default = true,
            tooltip = L.SpellReflectionTooltip,
            onChange = function(self, checked)
                cfg.useSpellReflection = checked
                print("|cff00ff00[" .. L.RoutineName .. "]|r " .. L.UseSpellReflection .. " " .. (checked and (isZhCN and "已启用" or "Enabled") or (isZhCN and "已禁用" or "Disabled")))
            end
        })
        :Slider({
            text = L.CastProgress,
            ...
            max = 80,
            step = 5,
            tooltip = L.SpellReflectionCastTooltip,
            onChange = function(self, value)
                cfg.spellReflectionCastPercent = value
                print("|cff00ff00[" .. L.RoutineName .. "]|r " .. L.UseSpellReflection .. " " .. L.CastProgress .. ": " .. value .. "%")
            end
        })
        ...
        :Slider({
            ...
            max = 255,
            step = 10,
            tooltip = (isZhCN and "调整圆圈的透明度\n数值越高越明显（50-255）" or "Adjust circle opacity\nHigher values = more visible (50-255)"),
            onChange = function(self, value)
    ...
    gui:Tab(L.TabInterrupt)
        :Header({ text = Aurora.texture(6552, 16) .. " " .. L.InterruptHeader })
        :Checkbox({
            text = L.UseAuroraList,
            key = "fury.interrupt.withList",
            default = true,
            tooltip = L.AuroraListTooltip,
            onChange = function(self, checked)
                cfg.interruptWithList = checked
                local mode = checked and (isZhCN and "仅列表" or "List Only") or (isZhCN and "全部" or "All")
                print("|cff00ff00[" .. L.RoutineName .. "]|r " .. L.UseAuroraList .. ": " .. mode)
            end
        })
        :Slider({
            text = L.InterruptCastProgress,
            key = "fury.interrupt.castPercent",
            default = 60,
            min = 20,
            max = 80,
            step = 5,
            tooltip = L.InterruptCastTooltip,
            onChange = function(self, value)
                cfg.interruptCastPercent = value
                print("|cff00ff00[" .. L.RoutineName .. "]|r " .. L.InterruptCastProgress .. ": " .. value .. "%")
            end
        })
        
        -- 风暴之锤
        :Checkbox({
            text = Aurora.texture(107570, 14) .. " " .. L.UseStormBolt,
            key = "fury.interrupt.stormBolt",
            default = true,
            tooltip = L.StormBoltTooltip,
            onChange = function(self, checked)
                cfg.useStormBolt = checked
                print("|cff00ff00[" .. L.RoutineName .. "]|r " .. L.UseStormBolt .. " " .. (checked and (isZhCN and "已启用" or "Enabled") or (isZhCN and "已禁用" or "Disabled")))
            end
        })
        :Slider({
            text = L.CastingEnemies,
            key = "fury.interrupt.stormBoltEnemyCount",
            default = 1,
            min = 1,
            max = 10,
            step = 1,
            tooltip = (isZhCN and "当读条且可打断的怪物数量 >= 此值时才使用" or "Use when casting enemies ≥ this value"),
            onChange = function(self, value)
                cfg.stormBoltEnemyCount = value
                print("|cff00ff00[" .. L.RoutineName .. "]|r " .. L.UseStormBolt .. " " .. L.CastingEnemies .. ": " .. value)
            end
        })
        
        -- 震荡波
        :Checkbox({
            text = Aurora.texture(46968, 14) .. " " .. L.UseShockwave,
            key = "fury.interrupt.shockwave",
            default = true,
            tooltip = L.ShockwaveTooltip,
            onChange = function(self, checked)
                cfg.useShockwave = checked
                print("|cff00ff00[" .. L.RoutineName .. "]|r " .. L.UseShockwave .. " " .. (checked and (isZhCN and "已启用" or "Enabled") or (isZhCN and "已禁用" or "Disabled")))
            end
        })
        :Slider({
            text = L.CastingEnemies,
            ...
            onChange = function(self, value)
                ...
                print("|cff00ff00[" .. L.RoutineName .. "]|r " .. L.UseShockwave .. " " .. L.CastingEnemies .. ": " .. value)
            end
        })
        
        -- 拳击
        :Checkbox({
            text = Aurora.texture(6552, 14) .. " " .. L.UsePummel,
            key = "fury.interrupt.pummel",
            default = true,
            tooltip = L.PummelTooltip,
            onChange = function(self, checked)
                cfg.usePummel = checked
                print("|cff00ff00[" .. L.RoutineName .. "]|r " .. L.UsePummel .. " " .. (checked and (isZhCN and "已启用" or "Enabled") or (isZhCN and "已禁用" or "Disabled")))
            end
        })
    ...
    gui:Tab(L.TabBurst)
        ...
        :Checkbox({
            ...
            default = true,
            tooltip = L.RecklessnessTooltip,
            onChange = function(self, checked)
                cfg.useRecklessness = checked
                print("|cff00ff00[" .. L.RoutineName .. "]|r " .. L.UseRecklessness .. " " .. (checked and (isZhCN and "已启用" or "Enabled") or (isZhCN and "已禁用" or "Disabled")))
            end
        })
        :Slider({
            text = L.TTDThreshold,
            ...
            max = 30,
            step = 1,
            tooltip = L.TTDTooltipGeneric,
            onChange = function(self, value)
                cfg.recklessnessTTD = value
                print("|cff00ff00[" .. L.RoutineName .. "]|r " .. L.UseRecklessness .. " " .. L.TTDThreshold .. ": " .. value .. (isZhCN and "秒" or "s"))
            end
        })
        
        -- 天神下凡
        :Checkbox({
            text = Aurora.texture(107574, 14) .. " " .. L.UseAvatar,
            key = "fury.cooldowns.avatar",
            default = true,
            tooltip = L.AvatarTooltip,
            onChange = function(self, checked)
                cfg.useAvatar = checked
                print("|cff00ff00[" .. L.RoutineName .. "]|r " .. L.UseAvatar .. " " .. (checked and (isZhCN and "已启用" or "Enabled") or (isZhCN and "已禁用" or "Disabled")))
            end
        })
        :Slider({
            text = L.TTDThreshold,
            ...
            onChange = function(self, value)
                cfg.avatarTTD = value
                print("|cff00ff00[" .. L.RoutineName .. "]|r " .. L.UseAvatar .. " " .. L.TTDThreshold .. ": " .. value .. (isZhCN and "秒" or "s"))
            end
        })
        
        -- 剑刃风暴
        :Checkbox({
            text = Aurora.texture(446035, 14) .. " " .. L.UseBladestorm,
            key = "fury.cooldowns.bladestorm",
            default = true,
            tooltip = L.BladestormTooltip,
            onChange = function(self, checked)
                cfg.useBladestorm = checked
                print("|cff00ff00[" .. L.RoutineName .. "]|r " .. L.UseBladestorm .. " " .. (checked and (isZhCN and "已启用" or "Enabled") or (isZhCN and "已禁用" or "Disabled")))
            end
        })
        :Slider({
            text = L.TTDThreshold,
            ...
            onChange = function(self, value)
                ...
                print("|cff00ff00[" .. L.RoutineName .. "]|r " .. L.UseBladestorm .. " " .. L.TTDThreshold .. ": " .. value .. (isZhCN and "秒" or "s"))
            end
        })
    
    -- 天赋导入标签页
    gui:Tab(L.TabTalents)
        :Header({ text = L.TalentsHeader })
        :Button({
            text = Aurora.texture(134400, 16) .. " " .. L.TalentSlaughter,
            width = 200,
            height = 30,
            tooltip = L.TalentSlaughterTooltip,
            onClick = function()
                -- 天赋代码
    ...
    StaticPopupDialogs["SLAYER_TALENT_CODE"] = {
        text = (isZhCN and "天赋配置：大米屠戮\n\n" .. L.TalentCopyInst or "Talent Config: " .. L.TalentSlaughter .. "\n\n" .. L.TalentCopyInst),
        button1 = (isZhCN and "确定" or "OK"),
        timeout = 0,
        whileDead = true,
        hideOnEscape = true,
        hasEditBox = true,
